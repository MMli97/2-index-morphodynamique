"""
Index des Formes Conceptuelles Dynamiques — Scoring Cumulatif V2.1.1

PATCH V2.1.1:
- A2 corrigé: invariance d'échelle (sensibilité structurelle relative, pas taille du graphe)
- A5 corrigé: plasticité structurelle endogène (pas seulement révision institutionnelle explicite)
...
# ─────────────────────────────────────────────
# Calcul, comparaison V2.1 → V2.1.1
# ─────────────────────────────────────────────
...
def compute_all():
    print("=" * 135)
    print("SCORING V2.1.1 — Matrice corrigée (A2 invariant d'échelle, A5 plasticité endogène)")
    print("=" * 135)
